...
public class FileOperations {
    public static void writeToFile (UserLogin U)
    {
        ObjectOutputStream outputStream = null;

        try {
            // Read old objects
            ArrayList<UserLogin> UserList = readAllData();
    ...
    public static ArrayList <UserLogin>  readAllData ()
    {
        //  ArrayList initialized with size 0
        ArrayList<UserLogin> UserList = new ArrayList<UserLogin>(0);
        // Input stream
        ...
        try
        {
            ...
            while(!EOF) {
                try {
                    ...
                    UserLogin myObj = (UserLogin) inputStream.readObject();
    ...
    {
        ArrayList<UserLogin> list = readAllData();
